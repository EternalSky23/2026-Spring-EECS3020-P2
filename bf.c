...
/* ******************************************************************
Programming assignment 2: implementing distributed, asynchronous,
...
extern void rtinit0(void);
extern void rtinit1(void);
extern void rtinit2(void);
extern void rtinit3(void);
...
void creatertpkt(struct rtpkt *initrtpkt, int srcid, int destid, int mincosts[4])
{
  int i;
...
void init() /* initialize the simulator */
{
  ...
  sscanf(line, "%d", &change_value);

  getline(&line, &len, file);
  sscanf(line, "%d", &old_value);
...
int main()
{
   ...
   while (1) {
        ...
        if (eventptr->evtype == FROM_LAYER2 ) {
          ...
          print_min_cost2();
          print_min_cost3();
	        linkhandler0(1,change_value);
	        linkhandler1(0,change_value);
          printf("\n");
          // Change weight between 0 1 to 20
          printf("Change cost between Node 0 and Node 1 to %d\n", change_value);
          }
	        else   {
          print_min_cost0();
          print_min_cost1();
          print_min_cost2();
          print_min_cost3();
          linkhandler0(1, old_value);
          linkhandler1(0,old_value);
          printf("\n");
          // Change weight between 0 1 to 1
          printf("Change cost between Node 0 and Node 1 to %d\n", old_value);
          }
	      }
        else{
